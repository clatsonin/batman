...
st.subheader("Instant Insights for a Safe World")
...
if location:
    ...
    response = chat_session.send_message(
        f"{location} helpline number: " + descriptions_text
    )
